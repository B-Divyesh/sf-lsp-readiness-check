...
- Source fixture: [`examples/northstar-api`](../examples/northstar-api). `lsp-readiness demo` executes this fixture's TAP tests and its bundled LSP and formatter executables through the normal probe path. The website replay and downloadable packet are a signed record of that probe.
